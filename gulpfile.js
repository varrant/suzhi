...
gulp.task('serve', function() {
    ...
    gulp.watch("./webroot-dev/static/sass/*.scss", ['sass']); // sass监听
    gulp.watch("./webroot-dev/static/js/**/*.js", ['js-watch']); //js监听
    gulp.watch("./webroot-dev/views/**/*.html").on('change', browserSync.reload); //html监听
});
